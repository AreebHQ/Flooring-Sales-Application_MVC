...
public class FlooringMasteryDaoImpl implements  FlooringMasteryDao {
    ...
    public final String DATA_EXPORT_FILE ="Backup\\DataExport.txt";
    ...
    public FlooringMasteryDaoImpl(String orderFile)
    {
        DAILY_ORDERS_MASTER_FILE = orderFile;
    }

    public FlooringMasteryDaoImpl() throws FlooringMasteryPersistenceException{
        this.DAILY_ORDERS_MASTER_FILE = "Orders/MasterFile.txt";
        loadProducts();
        loadTax();
    ...
    private void writeOrderData(List<Order> orderList) {
        ...
        String orderFile = "Orders\\Order_"+fileDate+".txt";
